...
const styles = StyleSheet.create({
  ...
  onlineRow: { marginTop: -11, minHeight: 24, paddingHorizontal: 9, borderRadius: 12, backgroundColor: colors.surfaceStrong, borderWidth: 1, borderColor: colors.borderSoft, flexDirection: "row", alignItems: "center", gap: 8, zIndex: 2 },
  onlineDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: colors.success },
  offlineDot: { backgroundColor: colors.textMuted },
  onlineText: { color: colors.textSecondary, fontSize: 11, fontWeight: "800" },
  ...
  metaRow: { flexDirection: "row", flexWrap: "wrap", justifyContent: "center", gap: 8, marginTop: 10 },
  ...
  roleText: { color: colors.textSecondary, fontSize: 11, fontWeight: "900" },
  cityBadge: { minHeight: 28, paddingHorizontal: 9, borderRadius: 14, backgroundColor: colors.surfaceStrong, borderWidth: 1, borderColor: colors.borderSoft, flexDirection: "row", alignItems: "center", gap: 8 },
  ...
  action: { flex: 1, minHeight: 82, borderRadius: 20, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center", gap: 8 },
  ...
  postDate: { color: colors.textMuted, fontSize: 11, fontWeight: "700" },
  ...
  statText: { color: colors.textMuted, fontSize: 11, fontWeight: "700" },
