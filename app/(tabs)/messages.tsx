...
export default function MessagesScreen() {
  ...
  return (
    <LinearGradient colors={gradients.screen} style={styles.screen}>
      ...
      <View style={styles.sectionHeader}><Text style={styles.sectionTitle}>{filter === "groups" ? "Discussions de groupe" : "Discussions privées"}</Text><View style={styles.sectionCountShell}><Text style={styles.sectionCount}>{sortedConversations.length}</Text></View></View>
...
const styles = StyleSheet.create({
  screen: { flex: 1 }, toolbar: { width: "100%", maxWidth: MAX_CONTENT_WIDTH, alignSelf: "center", paddingHorizontal: 10, paddingTop: 10 },
  segmented: { height: 52, padding: 3, borderRadius: 16, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surface, flexDirection: "row", overflow: "hidden" },
  segmentButton: { flex: 1, minHeight: 48, borderRadius: 13, overflow: "hidden", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }, segmentText: { color: colors.textMuted, fontSize: 14, fontWeight: "800" }, segmentTextActive: { color: colors.text },
  sectionHeader: { width: "100%", maxWidth: MAX_CONTENT_WIDTH, alignSelf: "center", paddingHorizontal: spacing.md, paddingTop: 14, paddingBottom: 10, flexDirection: "row", alignItems: "center", gap: spacing.sm }, sectionTitle: { ...typography.heading3, color: colors.text, flex: 1, fontWeight: "900" },
  sectionCountShell: { minWidth: 28, height: 28, paddingHorizontal: 7, borderRadius: 14, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: "rgba(107,79,234,0.18)", alignItems: "center", justifyContent: "center" }, sectionCount: { color: colors.text, fontSize: 11, fontWeight: "900" },
  listViewport: { flex: 1, minHeight: 0, width: "100%", maxWidth: MAX_CONTENT_WIDTH, alignSelf: "center" }, list: { paddingHorizontal: 10, paddingBottom: 22 }, emptyList: { flexGrow: 1 },
  feedbackWrap: { width: "100%", maxWidth: MAX_CONTENT_WIDTH, alignSelf: "center", flex: 1, paddingHorizontal: spacing.md, alignItems: "center", justifyContent: "center" }, feedback: { width: "100%", maxWidth: 430, padding: spacing.lg, borderRadius: 24, borderWidth: 1, borderColor: colors.borderSoft, alignItems: "center", gap: spacing.sm }, emptyState: { flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: spacing.lg, gap: spacing.sm }, feedbackTitle: { ...typography.heading3, color: colors.text, textAlign: "center" }, feedbackText: { ...typography.body, color: colors.textMuted, textAlign: "center" },
  retryButton: { minHeight: 48, minWidth: 124, marginTop: spacing.sm, paddingHorizontal: spacing.md, borderRadius: 16, alignItems: "center", justifyContent: "center", backgroundColor: colors.primary }, retryText: { color: colors.white, fontWeight: "900" },
