...
const styles = StyleSheet.create({
  screen: { flex: 1 }, toolbar: { width: "100%", maxWidth: 720, alignSelf: "center", paddingHorizontal: 10, paddingTop: 10, paddingBottom: 8 }, modeBar: { height: 56, padding: 3, borderRadius: 16, borderWidth: 1, flexDirection: "row", overflow: "hidden" }, modeButton: { flex: 1, height: 48, overflow: "hidden", borderRadius: 12, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }, modeLabel: { fontSize: 11, fontWeight: "900" }, postPressable: { borderRadius: 22 }, postPressed: { opacity: 0.96, transform: [{ scale: 0.996 }] }, feed: { width: "100%", maxWidth: 720, alignSelf: "center", paddingHorizontal: 10, paddingBottom: 24 }, rows: { gap: 9 }, wideRow: { width: "100%" }, pairRow: { width: "100%", flexDirection: "row", alignItems: "stretch", gap: 9 }, halfColumn: { flex: 1, minWidth: 0 }, emptyFeed: { width: "100%", minHeight: 180, alignItems: "center", justifyContent: "center", gap: 8 }, emptyText: { ...typography.bodySmall },
