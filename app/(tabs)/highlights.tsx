...
export default function HighlightsScreen() {
  ...
  const openSelectedAction = async (action: "message" | "audio" | "video") => {
    ...
    try { const conversation = await ensureSelectedConversation(); if (action === "message") router.push(`/chat/${encodeURIComponent(conversation.id)}`); else router.push({ pathname: "/call/[id]", params: { id: conversation.id, mode: action } }); }
