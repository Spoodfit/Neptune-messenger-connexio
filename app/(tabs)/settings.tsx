    ...
    <LinearGradient colors={gradients.screen} style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.contentColumn}>
          ...
          <Pressable accessibilityRole="button" accessibilityLabel="Se déconnecter" disabled={signingOut} onPress={() => void handleSignOut()} style={({ pressed }) => [styles.signOutButton, pressed && styles.pressed, signingOut && styles.disabled]}>{signingOut ? <ActivityIndicator color={colors.danger} /> : <><Ionicons name="log-out-outline" size={22} color={colors.danger} /><View style={styles.signOutContent}><Text style={styles.signOutText}>Se déconnecter</Text><Text style={styles.signOutHint}>Action rapide — aucune suppression de compte</Text></View></>}</Pressable>
...
const styles = StyleSheet.create({
  ...
  sectionHeading: { marginHorizontal: spacing.md, marginTop: spacing.lg, marginBottom: 10 }, sectionTitle: { ...typography.heading2, color: colors.text }, sectionSubtitle: { ...typography.bodySmall, color: colors.textMuted, marginTop: 4 },
  businessGrid: { marginHorizontal: spacing.md, flexDirection: "row", flexWrap: "wrap", gap: 10 }, businessCard: { flexGrow: 1, flexBasis: 210, minHeight: 150, padding: 14, borderRadius: 20, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surface }, businessIcon: { width: 42, height: 42, borderRadius: 14, backgroundColor: "rgba(244,177,131,0.12)", alignItems: "center", justifyContent: "center" }, businessTitle: { ...typography.heading3, color: colors.text, marginTop: 10 }, businessDescription: { ...typography.bodySmall, color: colors.textMuted, marginTop: 5, flex: 1 }, businessFooter: { marginTop: 12, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, businessKind: { color: colors.orange, fontSize: 10, fontWeight: "900" },
  recentPosts: { marginHorizontal: spacing.md, gap: 8 }, postCard: { minHeight: 66, padding: 12, borderRadius: 17, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surface, flexDirection: "row", alignItems: "center", gap: 10 }, postKind: { color: colors.orange, fontSize: 9, fontWeight: "900" }, postText: { flex: 1, color: colors.textSecondary, fontSize: 12, lineHeight: 17 },
  settingsList: { marginHorizontal: spacing.md, gap: 8 }, row: { minHeight: 68, padding: 12, borderRadius: 18, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surface, flexDirection: "row", alignItems: "center", gap: 12 }, rowIcon: { width: 42, height: 42, borderRadius: 14, backgroundColor: colors.surfaceStrong, alignItems: "center", justifyContent: "center" }, rowContent: { flex: 1, minWidth: 0 }, rowTitle: { ...typography.heading3, color: colors.text }, rowSubtitle: { ...typography.caption, color: colors.textMuted, marginTop: 3 }, pressed: { opacity: 0.78, transform: [{ scale: 0.992 }] },
  signOutError: { margin: spacing.md, color: colors.danger, backgroundColor: colors.dangerSoft, borderRadius: 14, padding: 12 }, signOutButton: { minHeight: 62, marginHorizontal: spacing.md, marginTop: spacing.lg, paddingHorizontal: 14, borderRadius: 18, borderWidth: 1, borderColor: colors.danger, backgroundColor: colors.dangerSoft, flexDirection: "row", alignItems: "center", gap: 12 }, signOutContent: { flex: 1 }, signOutText: { color: colors.danger, fontSize: 14, fontWeight: "900" }, signOutHint: { color: colors.textMuted, fontSize: 10, marginTop: 2 }, disabled: { opacity: 0.5 },
  systemSettings: { minHeight: 48, marginTop: 16, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }, systemSettingsText: { color: colors.textMuted, fontSize: 11, fontWeight: "800" }, version: { color: colors.textMuted, fontSize: 10, textAlign: "center", marginBottom: 8 }
});