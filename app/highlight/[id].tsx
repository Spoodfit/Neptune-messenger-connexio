    ...
    >
      ...
      >
        {item.author.avatarUrl ? (
          ...
          <Text style={styles.avatarInitials}>{item.author.initials}</Text>
        )}
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  commentAvatar: { width: 38, height: 38, borderRadius: 13, overflow: "hidden", backgroundColor: colors.primarySoft, alignItems: "center", justifyContent: "center" },
  avatarImage: { width: "100%", height: "100%" },
  avatarInitials: { color: colors.text, fontSize: 10, fontWeight: "900" },
  ...
  commentDate: { color: colors.textMuted, fontSize: 8.5 },
  commentActionText: { color: colors.orange, fontSize: 9, fontWeight: "800" },
  commentReactionPicker: { marginTop: 7, minHeight: 44, paddingHorizontal: 4, borderRadius: 22, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surfaceStrong, flexDirection: "row", alignItems: "center", justifyContent: "space-around" },
  commentReactionChoice: { width: 38, height: 38, alignItems: "center", justifyContent: "center" },
  commentReactionEmoji: { fontSize: 20 },
  commentReactionSummary: { marginTop: 7, flexDirection: "row", flexWrap: "wrap", gap: 5 },
  commentReactionPill: { minHeight: 25, paddingHorizontal: 7, borderRadius: 13, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surfaceStrong, flexDirection: "row", alignItems: "center", gap: 4 },
  commentReactionPillActive: { borderColor: colors.violet, backgroundColor: "rgba(107,79,234,0.22)" },
  smallEmoji: { fontSize: 11 },
  smallCount: { color: colors.textSecondary, fontSize: 9, fontWeight: "800" },
  ...
  suggestionCompany: { color: colors.textMuted, fontSize: 10, marginTop: 1 },
  ...
  replyingTitle: { color: colors.orange, fontSize: 10, fontWeight: "900" },
  ...
  input: { flex: 1, minWidth: 0, minHeight: 46, maxHeight: 118, paddingHorizontal: spacing.md, paddingVertical: 11, borderRadius: 20, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surfaceStrong, color: colors.text, ...typography.bodySmall },
