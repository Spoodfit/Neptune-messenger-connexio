...
const styles = StyleSheet.create({
  ...
  infoText: { flex: 1, color: colors.textSecondary, fontSize: 11, lineHeight: 14 },
  ...
  label: { color: colors.textSecondary, fontSize: 11, fontWeight: "900", marginBottom: 6, marginTop: 10 },
  input: { minHeight: 48, paddingHorizontal: 13, paddingVertical: 11, borderRadius: 16, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surfaceStrong, color: colors.text, fontSize: 14 },
  ...
  frequencyLabel: { color: colors.textMuted, fontSize: 11, fontWeight: "900" },
  frequencyLabelSelected: { color: colors.text },
  frequencyDescription: { color: colors.textMuted, fontSize: 11, marginTop: 3 },
  presetGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  presetButton: { flexGrow: 1, flexBasis: 130, minHeight: 48, paddingHorizontal: 10, borderRadius: 15, borderWidth: 1, borderColor: colors.borderSoft, backgroundColor: colors.surfaceStrong, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 },
  presetSelected: { borderColor: colors.orange, backgroundColor: "rgba(244,177,131,0.11)" },
  presetText: { color: colors.textMuted, fontSize: 11, fontWeight: "800" },
  ...
  enabledSubtitle: { color: colors.textMuted, fontSize: 11, marginTop: 3 },
  ...
  countText: { color: colors.textSecondary, fontSize: 11, fontWeight: "900" },
  ...
  emptyTitle: { color: colors.text, fontSize: 14, fontWeight: "900", marginTop: 9 },
  emptyText: { color: colors.textMuted, fontSize: 11, marginTop: 4, textAlign: "center" },
  ...
  automationName: { color: colors.text, fontSize: 14, lineHeight: 16, fontWeight: "900" },
  automationMeta: { color: colors.textMuted, fontSize: 11, marginTop: 3 },
  creator: { color: colors.orange, fontSize: 11, marginTop: 3, fontWeight: "800" },
  automationBody: { color: colors.textSecondary, fontSize: 11, lineHeight: 15, marginTop: 10 },
  cardActions: { marginTop: 10, flexDirection: "row", gap: 8 },
  cardAction: { flex: 1, minHeight: 48, borderRadius: 14, backgroundColor: colors.surfaceStrong, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 },
  deleteAction: { backgroundColor: colors.dangerSoft },
  cardActionText: { color: colors.textSecondary, fontSize: 11, fontWeight: "900" },
  deleteText: { color: colors.danger, fontSize: 11, fontWeight: "900" },
  actionDisabled: { opacity: 0.35 },
  readOnlyText: { color: colors.textMuted, fontSize: 11, textAlign: "center", marginTop: 7 },
