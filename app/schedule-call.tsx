  ...
  return (
    <LinearGradient colors={theme.pageGradient} style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: Math.max(insets.bottom, 18) + 106 }]} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        {env.mockMode ? <View style={[styles.mockInfo, { backgroundColor: theme.violetSoft }]}><Ionicons name="flask-outline" size={18} color={theme.violet} /><Text style={[styles.mockText, { color: theme.pageTextMuted }]}>Standalone : la demande est enregistrée localement. Vous pourrez simuler son acceptation depuis l’écran Appels. Le backend remplacera cette simulation par une vraie invitation.</Text></View> : null}
