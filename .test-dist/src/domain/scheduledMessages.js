...
exports.canScheduleMessages = canScheduleMessages;
...
function canScheduleMessages(role, canManageConversation) {
    return (canManageConversation && AUTHORIZED_ROLES.has((0, roles_1.normalizeUserRole)(role)));
}
function createScheduledMessage(input) {
    if (!canScheduleMessages(input.role, input.canManageConversation)) {
        throw new Error("Seuls les Capitaines, Amiraux et Visionnaires responsables de ce groupe peuvent programmer un message.");
    }
