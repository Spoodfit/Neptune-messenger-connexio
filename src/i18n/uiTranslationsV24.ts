...
export const UI_TRANSLATIONS_V24: Record<string, TranslationSet> = {
  ...
  "Espace de déplacement de la Salle générale": { en: "General room movement area", es: "Área de movimiento de la sala general", de: "Bewegungsbereich im allgemeinen Raum", it: "Area di movimento della sala generale", pt: "Área de movimento da sala geral" },
  ...
  "Impossible de quitter la salle": { en: "Unable to leave the room", es: "No se puede salir de la sala", de: "Raum konnte nicht verlassen werden", it: "Impossibile uscire dalla sala", pt: "Não foi possível sair da sala" },
  ...
  "La caméra n’a pas pu être activée.": { en: "The camera could not be enabled.", es: "No se pudo activar la cámara.", de: "Die Kamera konnte nicht aktiviert werden.", it: "Non è stato possibile attivare la fotocamera.", pt: "Não foi possível ativar a câmara." },
  "Le client caméra du Coworking est indisponible.": { en: "The Coworking camera client is unavailable.", es: "El cliente de cámara del Coworking no está disponible.", de: "Der Coworking-Kameraclient ist nicht verfügbar.", it: "Il client della fotocamera Coworking non è disponibile.", pt: "O cliente de câmara do Coworking não está disponível." },
  ...
  "Réponse non envoyée": { en: "Response not sent", es: "Respuesta no enviada", de: "Antwort nicht gesendet", it: "Risposta non inviata", pt: "Resposta não enviada" },
