...
export default function CoworkingMediaSurfaceWeb({ session, mapMode = false, spatialAudio = false, gridLayout = false, roomViewMode }: CoworkingMediaSurfaceProps) {
  ...
  if (mapMode || spatialAudio || gridLayout || roomViewMode || session.mock) return null;
