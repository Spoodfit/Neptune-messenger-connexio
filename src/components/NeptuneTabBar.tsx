...
const styles = StyleSheet.create({
  outer: { paddingHorizontal: 8, paddingTop: 4, position: "relative", zIndex: 40 },
  dismissLayer: { position: "absolute", left: -20, right: -20, top: -190, bottom: 0, zIndex: 1 },
  bar: { height: 72, padding: 5, overflow: "visible", position: "relative", borderRadius: radii.xl, borderWidth: 1, flexDirection: "row", alignItems: "center", elevation: 18, zIndex: 2, shadowColor: "#000", shadowOpacity: 0.14, shadowRadius: 12, shadowOffset: { width: 0, height: 5 } },
  ...
  createShell: { position: "absolute", left: "50%", marginLeft: -29, top: -11, width: 58, height: 58, borderRadius: 29, padding: 4, zIndex: 6, elevation: 24 }, createPressable: { flex: 1, borderRadius: 25 }, createPressed: { opacity: 0.86 }, createGradient: { flex: 1, borderRadius: 25, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.28)" },
  quickAction: { position: "absolute", top: 0, zIndex: 5, width: 132, height: 56, borderRadius: 20, elevation: 24, shadowColor: "#000", shadowOpacity: 0.42, shadowRadius: 20, shadowOffset: { width: 0, height: 10 } }, quickMessage: { left: "50%", marginLeft: -142 }, quickHighlight: { left: "50%", marginLeft: 10 }, quickPressable: { flex: 1, borderRadius: 20, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.32)" }, quickPressed: { opacity: 0.86, transform: [{ scale: 0.97 }] }, quickGradient: { flex: 1, paddingHorizontal: 9, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7 }, quickIcon: { width: 30, height: 30, borderRadius: 15, backgroundColor: "rgba(2,7,19,0.26)", alignItems: "center", justifyContent: "center" }, quickLabel: { color: colors.white, fontSize: 11, fontWeight: "900", textShadowColor: "rgba(0,0,0,0.35)", textShadowRadius: 4 }
});
