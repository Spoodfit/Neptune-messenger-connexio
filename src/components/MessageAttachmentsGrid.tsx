...
const styles = StyleSheet.create({
  ...
  overflow: { ...StyleSheet.absoluteFill, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(2,7,19,0.68)" },
  ...
  fileName: { fontSize: 11.5, lineHeight: 15, fontWeight: "850" },
