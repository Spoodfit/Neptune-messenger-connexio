...
const styles = StyleSheet.create({
  ...
  visualLabel: { position: "absolute", left: 7, right: 7, bottom: 7, minHeight: 34, paddingHorizontal: 8, borderRadius: 10, backgroundColor: "rgba(2,7,19,0.76)", flexDirection: "row", alignItems: "center", gap: 6 },
  visualLabelText: { flex: 1, color: colors.white, fontSize: 9, fontWeight: "800" },
  expandVideo: { position: "absolute", right: 8, top: 8, width: 44, height: 44, borderRadius: 15, backgroundColor: "rgba(2,7,19,0.76)", alignItems: "center", justifyContent: "center" },
  ...
  voicePlay: { width: 44, height: 44, borderRadius: 16, alignItems: "center", justifyContent: "center" },
  ...
  speedButton: { minWidth: 44, minHeight: 44, paddingHorizontal: 6, borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.16)", alignItems: "center", justifyContent: "center" },
  speedText: { fontSize: 9, fontWeight: "900" },
  voiceName: { flex: 1, fontSize: 8.5, textAlign: "right", fontWeight: "700" },
  transcriptPending: { minHeight: 44, marginTop: 6, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.10)", flexDirection: "row", alignItems: "center", gap: 6 },
  transcriptPendingText: { fontSize: 9, fontWeight: "800" },
  transcriptToggle: { minHeight: 44, marginTop: 4, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.10)", flexDirection: "row", alignItems: "center", gap: 7 },
  ...
  documentRow: { maxWidth: "100%", flexDirection: "row", alignItems: "stretch", gap: 5 },
  documentMain: { flex: 1, minWidth: 0 },
  externalButton: { width: 44, minHeight: 56, borderRadius: 13, backgroundColor: "rgba(2,7,19,0.22)", alignItems: "center", justifyContent: "center" },
  ...
  attachmentName: { fontSize: 10.5, fontWeight: "900" },
  attachmentMeta: { marginTop: 3, fontSize: 8.5, fontWeight: "700" },
