...
export default function MemberProfileScreenV19() {
  ...
  const contentTopInset = headerTopInset + 64;
  ...
  return <LinearGradient colors={theme.pageGradient} style={styles.screen}>
    <View style={[styles.header, { paddingTop: headerTopInset, paddingLeft: 8 + insets.left, paddingRight: 8 + insets.right }]}> 
    ...
    <ScrollView contentContainerStyle={[styles.content, { paddingTop: contentTopInset, paddingLeft: spacing.md + insets.left, paddingRight: spacing.md + insets.right, paddingBottom: Math.max(insets.bottom, spacing.xl) }]} showsVerticalScrollIndicator={false}>
...
const styles = StyleSheet.create({
  ...
  content: { width: "100%", maxWidth: 720, alignSelf: "center" }, hero: { borderRadius: 28, borderWidth: 1, padding: 16, overflow: "hidden" }, identityRow: { flexDirection: "row", alignItems: "center", gap: 14 }, identityCopy: { flex: 1, minWidth: 0 }, availabilityRow: { flexDirection: "row", alignItems: "center", gap: 6 }, availabilityDot: { width: 7, height: 7, borderRadius: 4 }, availabilityText: { fontSize: 11, fontWeight: "900" }, name: { fontSize: 25, lineHeight: 30, fontWeight: "900", letterSpacing: -0.45, marginTop: 4 }, headline: { fontSize: 14, lineHeight: 19, fontWeight: "700", marginTop: 3 }, metaRow: { marginTop: 8, flexDirection: "row", alignItems: "center", flexWrap: "wrap", gap: 8 }, metaPill: { minHeight: 32, paddingHorizontal: 9, borderRadius: 999, flexDirection: "row", alignItems: "center", gap: 5 }, metaText: { fontSize: 11, fontWeight: "800" }, bio: { fontSize: 14, lineHeight: 20, marginTop: 13 },
